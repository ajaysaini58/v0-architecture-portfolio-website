            ...
            <div>
              ...
              <div className="space-y-8">
                <div className="flex gap-4">
                  ...
                  <div>
                    <h3 className="font-semibold text-lg mb-1">Vetted Professionals</h3>
                    <p className="text-muted-foreground leading-relaxed">
                ...
                <div className="flex gap-4">
                  ...
                  <div>
                    <h3 className="font-semibold text-lg mb-1">Award-Winning Talent</h3>
                    <p className="text-muted-foreground leading-relaxed">
                ...
                <div className="flex gap-4">
                  ...
                  <div>
                    <h3 className="font-semibold text-lg mb-1">Seamless Collaboration</h3>
                    <p className="text-muted-foreground leading-relaxed">
