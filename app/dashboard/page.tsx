...
export default function DashboardPage() {
  ...
  const filteredBids = projectBids.filter((bid) => {
  ...
  const stats = [
    {
      ...
      value: projectBids.filter((b) => b.status === "Open").length,
      icon: AlertCircle,
      color: "text-green-600",
    },
    {
      label: "Under Review",
      value: projectBids.filter((b) => b.status === "Under Review").length,
      icon: Clock,
      color: "text-yellow-600",
    },
    {
      label: "Total Bids Received",
      value: projectBids.reduce((acc, b) => acc + b.bidsReceived, 0),
      icon: Users,
      color: "text-primary",
    },
    {
